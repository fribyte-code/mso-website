"""
Django settings for mso_website project.
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join("management", "templates"),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "mso_website.wsgi.application"
...
if os.environ.get("USE_DB_TYPE") == "postgres":
    DATABASES = {
        "default": {
